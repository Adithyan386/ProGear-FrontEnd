        ...
        <div className='container'>
            <div className='row'>
              <div class="card text-bg-dark mt-5 ms-5" style={{width:'18rem'}}>
                 ...
                 <h6 class="card-subtitle mb-2 text-body-secondary">Available Users: 00</h6>
                ...
                <div class="card text-bg-success mt-5 ms-5" style={{width:'18rem'}}>
                 <div class="card-body">
                   ...
                   <h6 class="card-subtitle mb-2 text-body-secondary">Available Orders: 00</h6>
               ...
               <div class="card text-bg-warning mt-5 ms-5" style={{width:'18rem'}}>
                 <div class="card-body">
                   ...
                   <h6 class="card-subtitle mb-2 text-body-secondary">Available Tracing: 00</h6>
               ...
               <div class="card text-bg-info mt-5 ms-5" style={{width:'18rem'}}>
                 <div class="card-body">
                   ...
                   <h6 class="card-subtitle mb-2 text-body-secondary">Available Products: 00</h6>
               ...
               <div class="card text-bg-light mt-5 ms-5" style={{width:'18rem'}}>
                 <div class="card-body">
                   ...
                   <h6 class="card-subtitle mb-2 text-body-secondary">Available Feedback: 00</h6>
               ...
               <div class="card text-bg-danger mt-5 ms-5" style={{width:'18rem'}}>
                 <div class="card-body">
                   ...
                   <h6 class="card-subtitle mb-2 text-body-secondary">Available Earning: $00</h6>
